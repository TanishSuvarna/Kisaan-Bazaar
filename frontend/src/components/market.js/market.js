        ...
        <div className="market">
          <MDBContainer>
            <div className="product-types">
              <h3 className="text-start ms-10 fw-bold">
                    ...
                    <MDBCardBody>
                      <MDBDropdown group>
                        ...
                        <MDBDropdownMenu>
                          ...
                          <MDBDropdownItem link>
                            <Link to="rice" spy={true} smooth={true}>
                              Rice
                            </Link>
                          </MDBDropdownItem>
                          <MDBDropdownItem link>
                            <Link to="corn" spy={true} smooth={true}>
                              Corn
                            </Link>
                          </MDBDropdownItem>
                        </MDBDropdownMenu>
                  ...
                  <div className="card">
                    <div className="market-item px-2">
                      <div className="item-img">
                        <img
                          src="https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fHdoZWF0JTIwZmxvdXJ8ZW58MHx8MHx8&w=1000&q=80"
                          alt=""
                        />

  ...
  return (
    <>
      ...
      <div className="market-main-container">
        <h1 className="text-danger fw-bold text-center mb-5 market-heading"><span> {category}</span> Market</h1>
        
        <div className="select-option-market-div">
        <p>Chose According to your Choice</p>
        <select className="select-option-market" value={filter} onChange={(e) => setFilter(e.target.value)}>
